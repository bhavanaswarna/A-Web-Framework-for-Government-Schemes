      ...
      <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item ">
                      <a class="nav-link" href="addschemes.jsp">Add Schemes</a>
                  </li>
                  <li class="nav-item ">
                      <a class="nav-link" href="viewschemes.jsp">View Schemes</a>
                  </li>
                  <li class="nav-item ">
        ...
        <div class="container">
            <ul class="breadcrumbs-custom-path">
              <li><a href="admin_home.jsp">Home</a></li> 
                <li class="active"><span class="fa fa-chevron-right mx-2" aria-hidden="true"></span> <%=sub%></li>
